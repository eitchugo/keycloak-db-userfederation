...
public class DatabaseUserDelegate extends UserModelDelegate {

	protected static final Logger LOGGER = Logger.getLogger(DatabaseUserDelegate.class);
	
	protected DatabaseUser databaseUser;
	
	protected boolean dirty;
	
	public DatabaseUserDelegate(UserModel delegate, DatabaseUser databaseUser) {
		super(delegate);
